...
pub fn root_help(cmd: &str) -> String {
    ...
    push_section(
        ...
        format_examples(&[
            ...
            format!("{cmd} dev shaks --no-ui"),
            format!("{cmd} dev shaks --no-watch"),
...
pub fn dev_help(cmd: &str) -> String {
    render_group(
        ...
        vec![
            ...
            format!("{cmd} dev shaks --no-ui"),
            format!("{cmd} dev shaks --no-watch"),
            format!("{cmd} dev shaks --no-watch --no-ui"),
            format!("{cmd} dev shaks --force"),
